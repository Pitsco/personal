...
public class RandomIntegers {
    public static void main(String[] args) {
        ...
        // Generate and print five random integers between 1 and 100
        for (int i = 0; i < 5; i++) {
            int randomInt = random.nextInt(100) + 1; // Generates a random int between 1 and 100
...
```java
int i = 5;
int result = i++; // The value of i is used, and then it is incremented.
System.out.println("i: " + i); // Prints "i: 6" because i was incremented by 1
System.out.println("result: " + result); // Prints "result: 5" because the original value of i (before increment) was used in result
